...
bool CCT::same_cm_point(int *src,int src_corner_num/*1右上3右下5左下7左上*/,int order_type/*7左上6左5左下4下3右下*/,int order_corner_num/*1右上3右下5左下7左上*/,CLOAD &order,int x,int y,int &CM_Size,bool check_diagonal){
